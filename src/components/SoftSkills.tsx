...
export default function SoftSkills() {
  return (
    <section id="soft-skills" className="py-28 px-6" style={{ background: 'transparent' }}>
        ...
        >
          {softSkills.map(s => (
            ...
            >
              ...
              <span className="font-semibold text-[0.82rem] text-center leading-tight" style={{ color: '#d9d9d4' }}>
                {s.label}
              </span>
            </motion.div>
          ))}
