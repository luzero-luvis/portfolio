  ...
  return (
    ...
    >
      <div className="flex items-center gap-1.5 px-4 py-3" style={{ background: 'rgba(0,0,0,0.35)', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
        <div className="w-3 h-3 rounded-sm" style={{ background: '#d82d17' }} />
        <div className="w-3 h-3 rounded-sm" style={{ background: '#d82d17' }} />
        <div className="w-3 h-3 rounded-sm" style={{ background: '#4398cd' }} />
        <span className="ml-2 font-mono text-[0.68rem]" style={{ color: '#8a8a86' }}>luvis@devops: ~/portfolio/about</span>
      </div>
        ...
        <div className="space-y-4">
            ...
            <div key={entry.id}>
              {entry.type === 'command' && (
                <div className="flex items-center gap-2 mb-1">
                  <span className="font-mono text-[0.82rem]" style={{ color: '#4398cd' }}>$</span>
                  <span className="font-mono text-[0.82rem]" style={{ color: '#d82d17' }}>{entry.lines[0]}</span>
                </div>
              )}
          ...
          >
            ...
            <input
              ...
              style={{ color: '#4398cd', caretColor: '#4398cd' }}
              spellCheck={false}
              autoCapitalize="off"
              autoComplete="off"
            ...
            />
            <span className="animate-blink inline-block w-[8px] h-[1em]" style={{ background: '#4398cd' }} />
          </form>
        </div>
      </div>
    </div>
