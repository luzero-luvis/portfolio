...
const links = [{ href: '/projects', label: 'Work', page: 'projects' }, { href: '/about', label: 'About', page: 'about' }, { href: '/skills', label: 'Expertise', page: 'skills' }, { href: '/blogs', label: 'Notes', page: 'blogs' }]
