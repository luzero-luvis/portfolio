        ...
        <div className="max-w-[1200px] mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="text-center sm:text-left">
            <div className="flex items-center gap-2.5 justify-center sm:justify-start">
              <Marks size={9} />
              <span className="font-display text-[1.5rem]" style={{ color: '#f4f4f2' }}>LUVIS.N10</span>
            </div>
            <div className="text-[0.8rem] mt-1" style={{ color: '#8a8a86' }}>DevOps Engineer · {profile.location}</div>
            <div className="text-[0.72rem] mt-1" style={{ color: '#8a8a86' }}>© {year} · Built with React · TypeScript · Tailwind · Framer Motion</div>
          </div>
          ...
          <div className="flex items-center gap-3">
            {[
              ...
              <a
                ...
                aria-label={l.label}
                className="w-11 h-11 rounded-sm flex items-center justify-center transition-all hover:-translate-y-1"
                style={{ background: 'rgba(255,255,255,0.06)', color: '#f4f4f2' }}
                onMouseEnter={e => { const t = e.currentTarget as HTMLAnchorElement; t.style.background = '#4398cd'; t.style.color = '#111112' }}
                onMouseLeave={e => { const t = e.currentTarget as HTMLAnchorElement; t.style.background = 'rgba(255,255,255,0.06)'; t.style.color = '#f4f4f2' }}
              >
                {l.icon}
              </a>
            ))}
