...
export default {
  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        display: ['"Space Mono"', 'ui-monospace', '"JetBrains Mono"', 'monospace'],
        sans: ['"Space Mono"', 'ui-monospace', '"JetBrains Mono"', 'Consolas', 'monospace'],
      ...
      colors: {
        ...
        yellow: '#edcb1f',
        green:  '#298f1a',
        cream:  { DEFAULT: '#f4f4f2', 2: '#eaeae6' },
        paper:  '#ffffff',
        sand:   { DEFAULT: '#d8d8d2', 2: '#c4c4bc' },
        ink:    '#121212',
        olive:  '#161616',
        muted:  { DEFAULT: '#4d4d4d', 2: '#8a8a86' },
        bg: {
          page:     '#f4f4f2',
          surface:  '#eaeae6',
          elevated: '#ffffff',
